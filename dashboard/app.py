...
.ds-cta-btn:hover{{
  background:{C['teal_act']};animation:none;transform:translateX(4px);}}
...
# ══ PAGE CARDS — HTML only, no buttons ════════════════════════════
page_cards = ""
for ico,title,desc in t["pages"]:
    page_cards += (
        ...
        f'<div style="font-size:.87rem;font-weight:600;color:{txt_dark};margin-bottom:5px;">{title}</div>'
